                ...
                <div class="col-md-12 col-lg-12">
                    <div class="d-flex justify-content-center align-items-center flex-column min-vh-100">
                        ...
                        <div class="formText my-auto text-center">
                            ...
                            <h6 class="lh-base">No worries – it happens to the best of us. Please enter <br> your email address below, along with your new password and confirmation</h6>
                            ...
                            <input type="hidden" name="token" value="{{ $token }}">
                                ...
                                <div class="form-group text-end inp-element">
                                    ...
                                    <input id="access-mail" type="email" class="form-control @error('email') is-invalid @enderror px-0 mb-2" name="email" value="{{ $email ?? old('email') }}" required placeholder="Email Address">
                                ...
                                <div class="form-group text-end inp-element">
                                    ...
                                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror mb-2" name="password" required placeholder="Enter Password">

                                </div>
                                <div class="form-group text-end inp-element">
                                    <input id="password-confirm" type="password" class="form-control mb-2" name="password_confirmation" required placeholder="Enter Confirm Password" >
                            
                                </div>
                                
                                <!-- Button trigger modal -->
                                <button type="submit" class="btn btn-primary submit-btn fw-semibold mt-3">Submit</button>
