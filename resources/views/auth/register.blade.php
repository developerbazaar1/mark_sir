...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('assets/css/request-access.css') }}">
</head>
<body>
    <section>
        <div class="container">
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="d-flex justify-content-center align-items-center flex-column min-vh-100">
                        ...
                        <div class="formText my-auto text-center">
                            ...
                            <h2 class="fw-semibold">Request Access</h2>
                            <h6 class="lh-base">Request access now and transform your product visuals into captivating <br> masterpieces for social media, retailers, and publishers.</h6>
                            ...
                            @csrf
                                <div class="form-group text-end inp-element">
                                    ...
                                    <input id="access-name" type="text" class="form-control px-0 @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required placeholder="Name" >
                                ...
                                <div class="form-group text-end inp-element">
                                    ...
                                    <input id="access-mail" type="email" class="form-control px-0 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required placeholder="Email Address">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content modal-cont border-0">
                                                <div class="modal-header border-bottom-0 p-0 justify-content-center">
                                                    <h4 class="modal-title m-0 fw-semibold" id="exampleModalLabel">Access Request Submitted!</h4>
                                                </div>
                                                <div class="modal-body p-0 align-self-stretch">Request received! We're reviewing it. Expect an email with instructions soon. Thank you!</div>
    ...
    <!-- Place this code at the end of your Blade view -->
    <script>
