...
<html>
  ...
  <body>
    ...
    <section class="login-content">
      <div class="logo">
        <img src="{{ URL::asset('admin-assets/images/logo.png') }}">
      </div>
      <div class="login-box">
       <!--  <form class="login-form" action="dashboard.html">
        ...
        <form class="login-form" method="POST" action="{{ route('login') }}">
          ...
          <div class="mb-3">
              <label class="form-label">USERNAME</label>
              <input class="form-control @error('email') is-invalid @enderror" type="text" name="email" placeholder="Email" autofocus value="{{ old('email') }}" required>
              @error('email')
        ...
        <form method="POST" class="forget-form" action="{{ route('password.email') }}">
          ...
          <div class="mb-3 btn-container d-grid">
            <button type="submit"  class="btn btn-primary btn-block"><i class="bi bi-unlock me-2 fs-5"></i>RESET</button>
          </div>
          <div class="mb-3 mt-3">
