...
<main class="app-content">
    <div class="app-title">
        <div>
          <h1>
            <i class="fa fa-th-large"></i> Add Site
          </h1>
        </div>
         <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="bi bi-house-door fs-6"></i></li>
        
          <li class="breadcrumb-item active"><a href="{{ route('admin-sites') }}">Site</a></li>
        </ul>
    </div>
                ...
                <div class="tile-body">
                    <div class=" cst-add-new-form row">
                        ...
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                             ...
                             @endif
                            <form class="Add-page-form w-auto " method="POST" action="{{route('admin-site-store')}}">
                              @csrf
                              
                              <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                  <div class="form-group">
                                      <label class="form-head">Site Name</label>
                     ...
                     <tbody>
                      @if(count($sites) > 0)
                        ...
                        <tr>
                           ...
                           <td class=""> 
                            <a class="btn btn-primary" href="{{ route('admin-site-edit', $site->id )}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a>
                            <!-- <a class="btn btn-primary" href="{{ route('admin-site-upload-errors', $site->id )}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Upload Errors</a> -->
                           </td>
                           <td class="">
                              <a href="#" class="delet-btn demoSwal" id="demoSwal" data-id="{{$site->id}}" data-uri="delete-site">
